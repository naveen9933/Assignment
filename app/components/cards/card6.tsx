  ...
  return (
    <div className="relative w-full h-[750px]">
      ...
      <div className="absolute top-[126px] left-[50%] transform translate-x-[-50%]">
        <img src={scaleup.src} alt="" className="w-32 h-32 mb-4" />
      </div>

      {/* Title */}
      <div className="absolute top-[270px] left-[50%] transform translate-x-[-50%] text-center">
        <div className="w-[238px] h-[29px] text-[24px] font-semibold mb-2">Scalability at Your Fingertips</div>
      </div>

      {/* Description */}
      <div className="absolute top-[314px] left-[50%] transform translate-x-[-50%] text-center">
        <div className="pt-[60px] text-[18px] w-[294px] h-[88px] mb-4">From one-on-one conversations to managing 10,000 concurrent calls, our platform scales effortlessly with your business.</div>
      </div>
