  ...
  return (
    <div className="relative w-full h-[750px]">
      ...
      <div className="absolute top-[126px] left-[50%] transform translate-x-[-50%]">
        <img src={brain.src} alt="" className="w-32 h-32 mb-4" />
      </div>

      {/* Title */}
      <div className="absolute top-[270px] left-[50%] transform translate-x-[-50%] text-center">
        <div className="w-[238px] h-[29px] text-[24px] font-semibold mb-2">Advanced Memory Recall</div>
      </div>

      {/* Description */}
      <div className="absolute top-[314px] left-[50%] transform translate-x-[-50%] text-center">
        <div className="pt-[60px] text-[18px] w-[294px] h-[88px] mb-4">Remembering context and details from earlier in the conversation, our AI provides a personalized and coherent interaction.</div>
      </div>
